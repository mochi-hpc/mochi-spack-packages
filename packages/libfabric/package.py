...
class Libfabric(Libfabric):
    ...
    version('1.10.rc2', tag='v1.10.0rc2')
    depends_on('m4', when='@1.10.rc2', type=('build'))
    depends_on('autoconf', when='@1.10.rc2', type=('build'))
    depends_on('automake', when='@1.10.rc2', type=('build'))
    depends_on('libtool', when='@1.10.rc2', type=('build'))
