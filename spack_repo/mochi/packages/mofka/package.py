...
class Mofka(CMakePackage):
    ...
    version("0.9.1", sha256="789b861d5a921ffdd30c7a4e6091a87441810faa59509b8968c75ceee2eceffa")
    ...
    version("0.8.0", sha256="57179ac374068dd37856283836268ed4ff0b7d0cc0274614eed6e7259afc3c1f")
    ...
    variant("mpi", default=False, when="@0.1.0:0.6.4",
