...
class MochiYokan(CMakePackage):
    ...
    version("0.10.0", sha256="a92d17c2d7b7b78d237de9b90539b7dc4ae56ff3d926af5721ad63f8ea8a22f4")
    version("0.9.2", sha256="16a5b80b35691ec4400bed93d9d18fe55f7b76ab2f15bf155dfb0f7e693e50f4")
    ...
    version("0.7.1", sha256="c2af4cd666fffc82c999ad1eb13dbad28a58f5b27388a169099df3870df6fa50")
    ...
    depends_on("py-mochi-margo@0.6.0:", when="+python @0.9.0:")
    ...
    depends_on("lua-sol2@:3.2.3", when="+lua", type=("build"))
